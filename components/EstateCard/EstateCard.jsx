import {Box, Badge, Icon, Flex, Text} from '@chakra-ui/react'
...
export default function EstateCard(){
    ...
    return(
      ...
      <Image loader={() => property.imageUrl} src={property.imageUrl} alt='alt' width='400px' height='300px'/>
